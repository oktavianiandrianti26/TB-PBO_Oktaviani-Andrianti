import java.io.BufferedReader; //menampung nilai reference library yg kita masukkan sebelumnya
...
public class Program {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean lanjutkan = true; //perulangan apabila menggunakan menu berapa kali
        int pilihan; 
        int a = 0; //untuk antrian
        ...
        }catch(ClassNotFoundException ex) { //jika tidak bisa terkoneksi maka akan muncul 
